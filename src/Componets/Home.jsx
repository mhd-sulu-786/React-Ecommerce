    ...
    return (
            ...
            <Card className="bg-dark text-white border-0  " id='action1'>
                ...
                <Card.ImgOverlay className='card-img-overplay  d-flex flex-column justify-content-center '>
                    <Card.Title className='card-title fw-bold mb-0 fs-1 display-3'>NEW SEASON ARRIVALS</Card.Title>
                    <Card.Text className='card-text lead fs-2'>CHECK OUT ALL THE TRENDS</Card.Text>
                </Card.ImgOverlay>
            </Card>
        </div>
